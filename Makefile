...
SOPC_FILE := D:/Dev/vhdl/program/University_Program/Computer_Systems/DE2-115/DE2-115_Media_Computer/verilog/nios_system.sopcinfo
...
# altera_up_sd_card_avalon_interface_driver sources root 
Altera_UP_SD_Card_Avalon_Interface_driver_SRCS_ROOT := drivers

# altera_up_sd_card_avalon_interface_driver sources 
Altera_UP_SD_Card_Avalon_Interface_driver_C_LIB_SRCS := \
	$(Altera_UP_SD_Card_Avalon_Interface_driver_SRCS_ROOT)/src/Altera_UP_SD_Card_Avalon_Interface.c

# avalon_audio_and_video_driver sources root 
Avalon_Audio_and_Video_driver_SRCS_ROOT := drivers

# avalon_audio_and_video_driver sources 
Avalon_Audio_and_Video_driver_C_LIB_SRCS := \
	$(Avalon_Audio_and_Video_driver_SRCS_ROOT)/src/altera_up_avalon_audio_and_video_config.c

# avalon_audio_driver sources root 
Avalon_Audio_driver_SRCS_ROOT := drivers

# avalon_audio_driver sources 
Avalon_Audio_driver_C_LIB_SRCS := \
	$(Avalon_Audio_driver_SRCS_ROOT)/src/altera_up_avalon_audio.c
...
# altera_nios2_gen2_ucosii_driver sources root 
altera_nios2_gen2_ucosii_driver_SRCS_ROOT := HAL

# altera_nios2_gen2_ucosii_driver sources 
altera_nios2_gen2_ucosii_driver_C_LIB_SRCS := \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/altera_nios2_gen2_irq.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_busy_sleep.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_irq_vars.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_icache_flush.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_icache_flush_all.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_dcache_flush.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_dcache_flush_all.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_dcache_flush_no_writeback.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_ecc_fatal_exception.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_instruction_exception_entry.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_irq_register.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_iic.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_remap_cached.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_remap_uncached.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_uncached_free.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_uncached_malloc.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_do_ctors.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_do_dtors.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_gmon.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_usleep.c \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/os_cpu_c.c

altera_nios2_gen2_ucosii_driver_ASM_LIB_SRCS := \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_ecc_fatal_entry.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_exception_entry.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_exception_trap.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_exception_muldiv.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_irq_entry.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_software_exception.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_mcount.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/alt_log_macro.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/crt0.S \
	$(altera_nios2_gen2_ucosii_driver_SRCS_ROOT)/src/os_cpu_a.S

# altera_up_avalon_video_dma_controller_driver sources root 
altera_up_avalon_video_dma_controller_driver_SRCS_ROOT := drivers

# altera_up_avalon_video_dma_controller_driver sources 
altera_up_avalon_video_dma_controller_driver_C_LIB_SRCS := \
	$(altera_up_avalon_video_dma_controller_driver_SRCS_ROOT)/src/altera_up_avalon_video_dma_controller.c

# avalon_character_lcd_driver sources root 
avalon_character_lcd_driver_SRCS_ROOT := drivers

# avalon_character_lcd_driver sources 
avalon_character_lcd_driver_C_LIB_SRCS := \
	$(avalon_character_lcd_driver_SRCS_ROOT)/src/altera_up_avalon_character_lcd.c

# avalon_parallel_port_driver sources root 
avalon_parallel_port_driver_SRCS_ROOT := drivers

# avalon_parallel_port_driver sources 
avalon_parallel_port_driver_C_LIB_SRCS := \
	$(avalon_parallel_port_driver_SRCS_ROOT)/src/altera_up_avalon_parallel_port.c

# avalon_video_pixel_buffer_dma_driver sources root 
avalon_video_pixel_buffer_dma_driver_SRCS_ROOT := drivers

# avalon_video_pixel_buffer_dma_driver sources 
avalon_video_pixel_buffer_dma_driver_C_LIB_SRCS := \
	$(avalon_video_pixel_buffer_dma_driver_SRCS_ROOT)/src/altera_up_avalon_video_pixel_buffer_dma.c
...
# ucosii sources root 
ucosii_SRCS_ROOT := UCOSII

# ucosii sources 
ucosii_C_LIB_SRCS := \
	$(ucosii_SRCS_ROOT)/src/alt_env_lock.c \
	$(ucosii_SRCS_ROOT)/src/alt_malloc_lock.c \
	$(ucosii_SRCS_ROOT)/src/os_core.c \
	$(ucosii_SRCS_ROOT)/src/os_dbg.c \
	$(ucosii_SRCS_ROOT)/src/os_flag.c \
	$(ucosii_SRCS_ROOT)/src/os_mbox.c \
	$(ucosii_SRCS_ROOT)/src/os_mem.c \
	$(ucosii_SRCS_ROOT)/src/os_mutex.c \
	$(ucosii_SRCS_ROOT)/src/os_q.c \
	$(ucosii_SRCS_ROOT)/src/os_sem.c \
	$(ucosii_SRCS_ROOT)/src/os_task.c \
	$(ucosii_SRCS_ROOT)/src/os_time.c \
	$(ucosii_SRCS_ROOT)/src/os_tmr.c

# up_avalon_irda_driver sources root 
up_avalon_irda_driver_SRCS_ROOT := drivers

# up_avalon_irda_driver sources 
up_avalon_irda_driver_C_LIB_SRCS := \
	$(up_avalon_irda_driver_SRCS_ROOT)/src/altera_up_avalon_irda.c

# up_avalon_ps2_driver sources root 
up_avalon_ps2_driver_SRCS_ROOT := drivers

# up_avalon_ps2_driver sources 
up_avalon_ps2_driver_C_LIB_SRCS := \
	$(up_avalon_ps2_driver_SRCS_ROOT)/src/altera_up_avalon_ps2.c \
	$(up_avalon_ps2_driver_SRCS_ROOT)/src/altera_up_ps2_keyboard.c \
	$(up_avalon_ps2_driver_SRCS_ROOT)/src/altera_up_ps2_mouse.c

# up_avalon_rs232_driver sources root 
up_avalon_rs232_driver_SRCS_ROOT := drivers

# up_avalon_rs232_driver sources 
up_avalon_rs232_driver_C_LIB_SRCS := \
	$(up_avalon_rs232_driver_SRCS_ROOT)/src/altera_up_avalon_rs232.c

# up_avalon_usb_driver sources root 
up_avalon_usb_driver_SRCS_ROOT := drivers

# up_avalon_usb_driver sources 
up_avalon_usb_driver_C_LIB_SRCS := \
	$(up_avalon_usb_driver_SRCS_ROOT)/src/altera_up_avalon_usb.c \
	$(up_avalon_usb_driver_SRCS_ROOT)/src/altera_up_avalon_usb_high_level_driver.c \
	$(up_avalon_usb_driver_SRCS_ROOT)/src/altera_up_avalon_usb_low_level_driver.c \
	$(up_avalon_usb_driver_SRCS_ROOT)/src/altera_up_avalon_usb_mouse_driver.c \
	$(up_avalon_usb_driver_SRCS_ROOT)/src/altera_up_avalon_usb_ptd.c
